...
INSERT INTO public.operations (
  ...
  status, purpose,
  docking_start_time, estimated_completion_time, operations_completed_at, actual_completion_time,
...
JOIN (
  VALUES
    ('DEMO-SI-0003', 1, 'DOCKED',      30, 1,
      NOW() - INTERVAL '1 hour', NOW() + INTERVAL '9 hours', NULL::timestamptz, NULL::timestamptz,
    ...
    ('DEMO-SI-0004', 2, 'IN_PROGRESS', 55, 2,
      NOW() - INTERVAL '4 hours', NOW() + INTERVAL '5 hours', NULL::timestamptz, NULL::timestamptz,
    ...
    ('DEMO-SI-0005', 3, 'SIGNOFF_APPROVED',   100, 3,
      NOW() - INTERVAL '12 hours', NOW() - INTERVAL '2 hours', NOW() - INTERVAL '2 hours 20 minutes', NULL::timestamptz,
    ...
    ('DEMO-SI-0006', 4, 'SAILED',      100, 4,
      NOW() - INTERVAL '28 hours', NOW() - INTERVAL '20 hours', NOW() - INTERVAL '20 hours 10 minutes', NOW() - INTERVAL '19 hours 30 minutes',
      ...
      NOW() - INTERVAL '19 hours 30 minutes'
         ...
         tb, estimated_completion_time, operations_completed_at, actual_completion_time,
         eta, ta, etb,
         nor_tendered_at, nor_accepted_at,
         no_pkk, priority,
...
SET
  ...
  operations_completed_at = o.operations_completed_at,
