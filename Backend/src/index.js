...
import samplingDocumentExtractRoutes from './routes/sampling-document-extract.js';
...
import integrationAdminRoutes from './routes/integration-admin.js';
import notificationAdminRoutes from './routes/notification-admin.js';
import datahubAdminRoutes from './routes/datahub-admin.js';
import adminOpsRoutes from './routes/admin-ops.js';
import masterVesselsRoutes from './routes/master-vessels.js';
...
apiV1.use('/integration-admin', integrationAdminRoutes);
apiV1.use('/notification-admin', notificationAdminRoutes);
apiV1.use('/datahub-admin', datahubAdminRoutes);
apiV1.use('/admin-ops', adminOpsRoutes);
apiV1.use('/rbac', rbacRoutes);
apiV1.use('/ports', portsRoutes);
apiV1.use('/jetties', jettiesRoutes);
/** Vessel master is global (not port-scoped), so it mounts above the catch-all requirePortScope routers. */
apiV1.use('/master/vessels', masterVesselsRoutes);
...
apiV1.use('/sampling-document-extract', requireAuth, requirePortScope, samplingDocumentExtractRoutes);
